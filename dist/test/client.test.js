...
describe("midtrans-client", () => {
    ...
    it("have Snap class", () => {
        (0, chai_1.expect)(typeof snap_1.Snap).to.be.equal("function");
    });
    it("have CoreApi class", () => {
        (0, chai_1.expect)(typeof coreApi_1.CoreApi).to.be.equal("function");
    });
    it("able to create CoreApi instance", () => {
        const core = new coreApi_1.CoreApi(generateConfig());
    ...
    it("able to create Snap instance", () => {
        const snap = new snap_1.Snap(generateConfig());
