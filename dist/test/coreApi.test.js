...
describe("CoreApi.js", () => {
    ...
    it("class should be working", () => {
        let core = new coreApi_1.default();
        (0, chai_1.expect)(core instanceof coreApi_1.default).to.be.true;
    ...
    it("able to get cc token", () => {
        let core = new coreApi_1.default(generateConfig());
        return core
            .cardToken({
    ...
    it("able to re-set serverKey via setter", () => {
        let core = new coreApi_1.default({ clientKey: "abc" });
